...
<body class="bg-primary-100">
    ...
    {{-- Hero Section --}}
    <section class="w-full max-w-7xl mx-auto py-16 text-center">
        ...
        <p class="text-body text-neutral-600 mb-16">
        ...
        <div class="grid grid-cols-4 gap-8">
            <div class="bg-neutral-300 rounded-[32px] h-[380px] grid place-content-center">
